...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a=document.querySelector(".feedback-form"),s="feedback-form-state";o();const l={email:a.email.value,message:a.message.value};function r({target:{name:e,value:t}}){l[e]=t,localStorage.setItem(s,JSON.stringify(l))}function n(e){e.preventDefault();const t={email:e.currentTarget.email.value,message:e.currentTarget.message.value};console.log(t),localStorage.removeItem(s),a.reset()}function o(){const e=JSON.parse(localStorage.getItem(s));e&&(e.email&&(a.email.value=e.email),e.message&&(a.message.value=e.message))}a.addEventListener("input",(0,e.default)(r,500)),a.addEventListener("submit",n);
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.237fcc74.js.map