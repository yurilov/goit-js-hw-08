...
"use strict";var e=a(require("lodash/throttle"));function a(e){return e&&e.__esModule?e:{default:e}}const t=document.querySelector(".feedback-form"),l="feedback-form-state";n();const s={email:t.email.value,message:t.message.value};function r({target:{name:e,value:a}}){s[e]=a,localStorage.setItem(l,JSON.stringify(s))}function m(e){e.preventDefault();const a={email:e.currentTarget.email.value,message:e.currentTarget.message.value};""!==a.email&&""!==a.message?(console.log(a),localStorage.removeItem(l),t.reset()):alert("Please fill all fields!")}function n(){const e=JSON.parse(localStorage.getItem(l));e&&(e.email&&(t.email.value=e.email),e.message&&(t.message.value=e.message))}t.addEventListener("input",(0,e.default)(r,500)),t.addEventListener("submit",m);
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.914e40a8.js.map